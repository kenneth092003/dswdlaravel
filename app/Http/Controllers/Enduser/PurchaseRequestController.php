...
class PurchaseRequestController extends Controller
{
    ...
    // ✅ UPDATED: now includes activity_date and venue
    public function storeBasicInfo(Request $request)
    {
        ...
        $purchaseRequest = DB::transaction(function () use ($validated, $status, $request) {
            ...
            // ✅ Saved to proper columns
            $purchaseRequest->activity_date     = $validated['activity_date'];
            $purchaseRequest->expected_venue    = $validated['venue'];
    ...
    // ✅ UPDATED: removed priority_level, uses proper columns
    public function updateBasicInfo(Request $request, $id)
    {
        ...
        $purchaseRequest->activity_date     = $validated['activity_date'];
        $purchaseRequest->expected_venue    = $validated['venue'];
        $purchaseRequest->remarks           = $validated['expected_output'] ?? 'Updated by End User.';
        $purchaseRequest->save();
