...
<head>
    ...
    <title>Procurement Overview – PROMIS</title>
...
<div class="main">
    ...
    <div class="topbar">
        <div>
            <div class="breadcrumb">Procurement › <span>Overview</span></div>
    ...
    <div class="content-inner">
        <div class="steps-nav">
            <a href="{{ route('procurement.dashboard') }}" class="step-tab {{ request()->routeIs('procurement.dashboard') ? 'active' : '' }}">
                <span class="step-badge">1</span>
                Overview
            </a>
            <a href="{{ route('procurement.step1') }}" class="step-tab {{ request()->routeIs('procurement.step1') ? 'active' : '' }}">
        ...
        <div class="stats-grid">
            <div class="stat-card blue">
                ...
                <div class="stat-label">Proposals for Approval</div>
                {{-- /* TODO: Count proposals awaiting approval from database */ --}}
            </div>
            <div class="stat-card gold">
                <div class="stat-number">0</div>
                <div class="stat-label">Incoming PRs (BAC)</div>
                {{-- /* TODO: Count incoming PRs from BAC processing table */ --}}
            </div>
            <div class="stat-card green">
                <div class="stat-number">0</div>
                <div class="stat-label">In Canvassing</div>
                {{-- /* TODO: Count PRs currently in canvassing stage */ --}}
            </div>
            <div class="stat-card red">
                <div class="stat-number">0</div>
                <div class="stat-label">PRs for Signature</div>
                {{-- /* TODO: Count PRs pending signature */ --}}
            </div>
            <div class="stat-card purple">
                <div class="stat-number">0</div>
                <div class="stat-label">Completed This Month</div>
                {{-- /* TODO: Count completed PRs for current month */ --}}
            </div>
        </div>

        <div class="section-header">
            <div class="section-title">Urgent - Action needed</div>
        ...
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    {{-- /* TODO: Populate urgent action items from procurement workflow tables */ --}}
                </tbody>
            </table>
        </div>
    </div>
