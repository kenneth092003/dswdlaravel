...
<head>
    ...
    <title>Step 3 – Sign PR – PROMIS</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-center { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 12px; padding: 80px 20px; color: var(--muted); text-align: center; }
        .page-center-icon { font-size: 48px; opacity: 0.3; }
        .page-center h2 { font-size: 18px; color: var(--text); font-weight: 600; }
        .page-center p { font-size: 13px; max-width: 360px; line-height: 1.6; }
...
<div class="main">
    ...
    <div class="topbar">
        <div>
            <div class="breadcrumb">Procurement › <span>Step 3</span></div>
            <div class="page-title">Step 3 – Sign PR</div>
        </div>
    ...
    <div class="content-inner">
        <div class="steps-nav">
            ...
            <div class="page-center">
                ...
                <h2>Sign Purchase Requests</h2>
                <p>This section will display purchase requests that are ready for signature once the backend workflow is implemented.</p>
                <p>{{-- /* TODO: Populate signable PRs from procurement workflow */ --}}</p>
            </div>
        </div>
    </div>
